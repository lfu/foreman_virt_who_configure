module ForemanVirtWhoConfigure
  class Config < ApplicationRecord
    ...
    def create_or_find_service_user
      service_user = ServiceUser.find_by(provider_type: hypervisor_type, provider_name: hypervisor_server, organization_id: organization_id)
      ...
      User.skip_permission_check do
        ...
        service_user = build_service_user(provider_type: hypervisor_type, provider_name: hypervisor_server, organization_id: organization_id)
