...
module ForemanVirtWhoConfigure
  class ConfigTest < ActiveSupport::TestCase
    ...
    describe 'config is created' do
      ...
      test 'multiple configs for same provider shares one service user' do
        new_config = FactoryBot.create(:virt_who_config, organization: existing_config.organization)
